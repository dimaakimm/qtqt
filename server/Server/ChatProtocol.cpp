...
QByteArray ChatProtocol::registrationErrorMessage(QString message)
{
    return getData(ErrorRegistration, message);
}
...
QString ChatProtocol::errorRegistrationMessage() const
{
    return _errorRegistrationMessage;
}
